export const techStack = [
  { name: 'Vue', src: '/icons/vue.svg', color: '#4FC08D' },
  ...
  { name: 'Redis', src: '/icons/redis.svg', color: '#DC382D' },
  { name: 'Docker', src: '/icons/docker.svg', color: '#2496ED' },
  { name: 'Git', src: '/icons/git.svg', color: '#F05032' },
  { name: 'Linux', src: '/icons/linux.svg', color: '#FCC624' },
  { name: 'Tailwind CSS', src: '/icons/tailwindcss.svg', color: '#06B6D4' }
];
